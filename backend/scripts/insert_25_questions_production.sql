...
INSERT INTO Explanations (questionId, text, whyWrong, `references`, aiGenerated, createdAt, updatedAt) VALUES (@prod_qid, 'The modified pen grasp is the standard grasp used in dental hygiene and periodontal instrumentation. The pads of the thumb and index finger hold the instrument handle, while the pad of the middle finger rests on the shank to feel tactile vibrations and guide instrument movements.', 'Palm grasp is used for bulky surgical instruments or forceps. Standard pen grasp does not place the pad of the middle finger on the shank, resulting in less control and decreased tactile sensitivity. Reverse palm grasp is used in specific retracting situations.', 'Clinical Dental Examination', 1, NOW(), NOW());
...
INSERT INTO Explanations (questionId, text, whyWrong, `references`, aiGenerated, createdAt, updatedAt) VALUES (@prod_qid, 'A Stillman''s cleft is a specific narrow, V-shaped or slit-like indentation/slit in the marginal gingiva that extends apically from the gingival margin toward or through the mucogingival junction, historically associated with trauma from occlusion or improper toothbrushing trauma.', 'McCall''s festoon is an exaggerated roll-shaped enlargement/thickening of the marginal gingiva, often seen in the canine and premolar areas. Generalized gingival recession refers to apical migration of the gingival margin without the characteristic narrow V-shaped cleft slit. A periodontal pocket is a pathological deepening of the gingival sulcus.', 'Clinical Dental Examination', 1, NOW(), NOW());
...
INSERT INTO Explanations (questionId, text, whyWrong, `references`, aiGenerated, createdAt, updatedAt) VALUES (@prod_qid, 'A caliber-persistent artery is a vascular anomaly where a main arterial branch enters the superficial submucosa without a reduction in diameter, presenting clinically as a linear or papular pulsatile mucosal elevation, typically on the lower lip of older adults.', 'Mucocele is a non-pulsatile pseudocyst containing mucus due to severed salivary ducts. Varicosity (lingual varix) presents as a blue-purple dilatated vein, most common on the ventral tongue and non-pulsatile. Pyogenic granuloma is a lobulated, ulcerated reactive vascular hyperplasia.', 'Clinical Dental Examination', 1, NOW(), NOW());
...
INSERT INTO Explanations (questionId, text, whyWrong, `references`, aiGenerated, createdAt, updatedAt) VALUES (@prod_qid, 'Bohn''s nodules are keratin-filled cysts derived from remnants of salivary gland tissue found scattered along the buccal and lingual aspects of the dental ridges (away from the midline) in infants.', 'Epstein''s pearls are located strictly along the median palatal raphe. Mucoceles and ranulas occur from salivary gland duct disruption and are translucent blue/cystic rather than tiny keratin cysts.', 'Clinical Dental Examination', 1, NOW(), NOW());
...
INSERT INTO Explanations (questionId, text, whyWrong, `references`, aiGenerated, createdAt, updatedAt) VALUES (@prod_qid, 'Epstein''s pearls are small, white-yellow epithelial inclusion cysts occurring along the median palatal raphe of newborns, formed by entrapped epithelium during palatal fusion.', 'Bohn nodules are found on the alveolar ridge (buccal/lingual), not on the palatal midline. Dental lamina cysts occur on the crest of the alveolar ridge. Mucoceles are uncommon in newborns and are not midline inclusion cysts.', 'Clinical Dental Examination', 1, NOW(), NOW());
...
INSERT INTO Explanations (questionId, text, whyWrong, `references`, aiGenerated, createdAt, updatedAt) VALUES (@prod_qid, 'The double papilla flap (Cohen and Ross technique) is a mucogingival surgical technique where interdental papillae from both sides of a recession defect are mobilized and joined together over the exposed root surface, useful when adjacent donor keratinized tissue is narrow.', 'A laterally positioned flap transposes a single donor flap sideways from an adjacent tooth. Coronally advanced flap mobilizes tissue coronally. Free gingival graft involves an unvascularized graft harvested from the palate.', 'Clinical Dental Examination', 1, NOW(), NOW());
...
INSERT INTO Explanations (questionId, text, whyWrong, `references`, aiGenerated, createdAt, updatedAt) VALUES (@prod_qid, 'The UCLA abutment is a castable or machined plastic sleeve that allows direct waxing and casting of the crown/framework directly to the implant fixture, useful for screw-retained or custom-angle restorations where interocclusal space is limited.', 'Healing abutments are domed titanium components placed during soft tissue healing. Impression copings have specific transfer retentive grooves to transfer fixture position in an impression. Cover screws are flat screws placed flush with the implant fixture during submerged healing.', 'Clinical Dental Examination', 1, NOW(), NOW());
...
INSERT INTO Explanations (questionId, text, whyWrong, `references`, aiGenerated, createdAt, updatedAt) VALUES (@prod_qid, 'Chalazion forceps have a ring-shaped loop on one side and a solid flat plate on the other with a locking screw. In oral surgery, they are commonly used during minor labial surgery (such as lower lip mucocele excision or minor salivary gland biopsy) to stabilize the lip, provide hemostasis, and isolate the surgical field.', 'Hemostats have transverse serrations for clamping blood vessels. Standard tissue forceps have toothed tips for grasping tissues. Needle holders have cross-hatched jaws with a central groove to hold suture needles.', 'Clinical Dental Examination', 1, NOW(), NOW());
